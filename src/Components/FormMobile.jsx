...
export default function FormMobile({mailSend,arrayForm,setForm,form,setErrorValidate,setErrorMail,setErrorName,setErrorDescription,errorName,errorValidate,errorDescription,errorMail,clickButton,handleClick,setClickButton,setMailSend}){
    return(
